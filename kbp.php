    ...
    <div class="main-data">
        <header>
            <div class="navbar">
                ...
                <ul>
                <li><a href="reg1.html"><b> Dashboard</a></li>
        ...
        <div class="row">
            ...
            <div class="clg-name">
               <h2>&emsp; Fill the following details </h2><br><h3>Name, ID-Card No, Aadhar No, Vaccination Doses etc.</h3>
            </div>
        </div><br>
        <!-- <div class="row">
            <div class="icon">
            ...
            <div class="clg-name">
            <a href="#"><h2>&emsp; YSPM's Yashoda Technical Campus Satara</h2></a>
            </div>
        </div><br>
        <div class="row">
            <div class="icon">
            ...
            <div class="clg-name">
            <a href="#"><h2>&emsp; Yashwantrao Chavan College Of Science, Satara</h2></a>
            </div>
        </div><br>
        <div class="row">
            <div class="icon">
            ...
            <div class="clg-name">
            <a href="#"><h2>&emsp; Sawkar Homoeopathic Medical College, Satara</h2></a>
            </div>
        </div><br><br> -->
        <br>
        <br>
